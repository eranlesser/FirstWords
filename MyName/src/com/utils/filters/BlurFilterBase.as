...
package com.utils.filters
{
	 ...
	 */
	public class BlurFilterBase extends FragmentFilter
	{
		 ...
		 *  cost.</p>
		 */
		public function BlurFilterBase(blurX:Number=1, blurY:Number=1, resolution:Number=1)
		{
			super(1, resolution);
			mBlurX = blurX;
			mBlurY = blurY;
		...
		public static function createDropShadow(distance:Number=4.0, angle:Number=0.785, 
												...
												resolution:Number=0.5):BlurFilterBase
		{
			var dropShadow:BlurFilterBase = new BlurFilterBase(blur, blur, resolution);
		...
		public static function createGlow(color:uint=0xffff00, alpha:Number=1.0, blur:Number=1.0,
										  resolution:Number=0.5):BlurFilterBase
		{
			var glow:BlurFilterBase = new BlurFilterBase(blur, blur, resolution);
