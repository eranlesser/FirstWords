package com.view.roomItems
{
	...
	public class BigBall extends PlayItem
	{
		
		private static const BALL_ELASTICITY : Number = 1.5;
		
		public function BigBall(space:Space,cbType:CbType,xx:int,yy:int)
		{
		...
		override protected function createMaterial():void{
			...
			_material.addChild(new Image(Room.atlas.getTexture("big_ball")) ) as Sprite;
