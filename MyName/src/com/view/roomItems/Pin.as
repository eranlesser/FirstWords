package com.view.roomItems
{
	...
	public class Pin extends PlayItem
	{
		private var _texture:String;
		
		public function Pin(space:Space,cbType:CbType,xx:int,yy:int,texture:String)
		{
			_texture = texture;
		...
		override protected function createMaterial():void{
			...
			_material.addChild( new Image(Room.atlas.getTexture(_texture)) ) as Sprite;
