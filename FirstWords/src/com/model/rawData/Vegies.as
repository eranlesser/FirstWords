package com.model.rawData
{
	public class Vegies
	{
		...
		public static var data:XML = 
			<data type="whereIsScreen" groupName="fruitsAndVeg" thumbNail="tomato" categorySound="category/fruitsandveg.mp3">
				<item image="caret" sound="fruitsandveg/carret.mp3" groupId="caret"/>
